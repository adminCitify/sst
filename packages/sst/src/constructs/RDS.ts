...
export class RDS extends Construct implements SSTConstruct {
  ...
  private getEngine(engine: RDSEngineType): IClusterEngine {
    ...
    throw new Error(
      `The specified "engine" is not supported for sst.RDS. Only mysql5.6, mysql5.7, postgresql11.13, postgresql11.16, postgres13.12 and postgres13.9 engines are currently supported.`
    );
  }
